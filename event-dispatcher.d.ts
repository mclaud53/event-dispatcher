declare module 'frog-event-dispatcher/Event' {
...
declare module 'frog-event-dispatcher/ListenerOptions' {
	/**
...
declare module 'frog-event-dispatcher/Listener' {
	import ev = require('frog-event-dispatcher/Event');
	import lo = require('frog-event-dispatcher/ListenerOptions');
...
declare module 'frog-event-dispatcher/EventDispatcher' {
	import ev = require('frog-event-dispatcher/Event');
	import ls = require('frog-event-dispatcher/Listener');
	import lo = require('frog-event-dispatcher/ListenerOptions');
	/**
